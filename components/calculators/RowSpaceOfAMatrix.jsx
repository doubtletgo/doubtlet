...
const RowSpaceOfAMatrix = () => {
  ...
  useEffect(() => {
    setNote(
      renderSteps([
        ...
        {
          value: putSpace(`Find the row space of the Matrix given as`),
          type: 'equation',
        },
        {
  ...
  useEffect(() => {
    ...
    const finalAnswer = [
      {
        value: putSpace(
          `The Row space matrix of the given matrix  \\{ ${rowSpaceMat
    ...
    const steps = [
      ...
      'br',
      {
        value: `The row space is the collection of all linear combinations of its rows or span of rows.`,
        type: 'span',
      },
      'br',
      {
      ...
      {
        value:
          'Since the row space is a space spanned by the non-zero rows of the reduced matrix.',
        type: 'span',
      },
      {
        value: putSpace(
          `Now the Row Space matrix is  \\{ ${rowSpaceMat
            .map((itm) => printMatrix(itm.map((el) => [el])))
            .join(',')} \\}`
        ),
        type: 'equation',
...
export default RowSpaceOfAMatrix;
