...
const ParallelPerpendicularLine = () => {
  const [p1, setP1] = useLocalStorage('ParallelPerpendicularLine_p1', '3');
  const [p2, setP2] = useLocalStorage('ParallelPerpendicularLine_p2', '2');
  const [y1, setY1] = useLocalStorage('ParallelPerpendicularLine_y1', '1');
  const [y2, setY2] = useLocalStorage('ParallelPerpendicularLine_y2', '5');
  const [equation, setEquation] = useLocalStorage('ParallelPerpendicularLine_equation', '');
  const [solution, setSolution] = useLocalStorage('ParallelPerpendicularLine_solution', '');
  const [result, setResult] = useLocalStorage('ParallelPerpendicularLine_result', undefined);
  const [showResult, setShowResult] = useLocalStorage('ParallelPerpendicularLine_showResult', false);
  const [showSteps, setShowSteps] = useLocalStorage('ParallelPerpendicularLine_showSteps', true);
  const [note, setNote] = useLocalStorage('ParallelPerpendicularLine_note', undefined);
  const [order, setOrder] = useLocalStorage('ParallelPerpendicularLine_order', 'Parallel');
