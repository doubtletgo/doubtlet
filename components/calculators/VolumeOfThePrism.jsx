...
const VolumeOfThePrism = () => {
  ...
  useEffect(() => {
    setNote(
      renderSteps([
        ...
        {
          value: putSpace(
            `Find the \\bold{Volume (V)} of the \\bold{Prism}, whose`
          ),
          type: 'equation',
        },
        {
  ...
  useEffect(() => {
    ...
    const finalAnswer = [
      {
        value: putSpace(
          `The Volume (V) of the Prism, whose base area is \\bold{{${valueToKatex(
            aValue
      ...
      {
        value: putSpace(`is \\bold{${evalInDecimals(v)}} Cubic units.`),
        type: 'equation',
      },
    ];
    const equations = [
    ...
    const steps = [
      ...
      {
        value: putSpace(
          `We know that the \\bold{Volume} of the \\bold{Prism} is given as`
        ),
        type: 'equation',
      },
      {
        value: putSpace(`V = (Area of base).(Height) = a.h`),
        type: 'equation',
      },
      'br',
      {
      ...
      {
        value: putSpace(`we can calculate the Volume of the prism.`),
        type: 'equation',
      },
      {
        value: `<b>Step-2</b>`,
      ...
      {
        value: putSpace(
          `V = ({${valueToKatex(aValue)}})({${valueToKatex(hValue)}})  `
        ),
        type: 'equation',
      },
      {
...
export default VolumeOfThePrism;
