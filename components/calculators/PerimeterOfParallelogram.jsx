...
const PerimeterOfParallelogram = () => {
  ...
  useEffect(() => {
    setNote(
      renderSteps([
        ...
        {
          value: putSpace(
            `Calculate the perimeter of the Parallelogram with a length of`
          ),
          type: 'equation',
        },
        {
  ...
  useEffect(() => {
    ...
    const finalAnswer = [
      {
        value: putSpace(`The Perimeter of the Parallelogram with a length of`),
        type: 'equation',
      },
      {
        value: putSpace(
    ...
    const steps = [
      ...
      {
        value: putSpace(`Perimeter of Parallelogram = 2(a + b)`),
        type: 'equation',
      },
      'br',
      {
...
export default PerimeterOfParallelogram;
