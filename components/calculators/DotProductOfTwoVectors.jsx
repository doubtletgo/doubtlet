...
const DotProductOfTwoVectors = () => {
  const [size, setSize] = useLocalStorage('DotProductOfTwoVectors_size', '3');
  const [vectorOne, setVectorOne] = useLocalStorage('DotProductOfTwoVectors_vectorOne', [['2', '2', '7']]);
  const [vectorTwo, setVectorTwo] = useLocalStorage('DotProductOfTwoVectors_vectorTwo', [['5', '7', '3']]);
  const isInvalid = useRef();
  const [equation, setEquation] = useLocalStorage('DotProductOfTwoVectors_equation', '');
  const [solution, setSolution] = useLocalStorage('DotProductOfTwoVectors_solution', '');
  const [result, setResult] = useLocalStorage('DotProductOfTwoVectors_result', undefined);
  const [showResult, setShowResult] = useLocalStorage('DotProductOfTwoVectors_showResult', true);
  const [showSteps, setShowSteps] = useLocalStorage('DotProductOfTwoVectors_showSteps', true);
  const [isPointSame, setIsPointSame] = useLocalStorage('DotProductOfTwoVectors_isPointSame', false);
  const [note, setNote] = useLocalStorage('DotProductOfTwoVectors_note', undefined);
