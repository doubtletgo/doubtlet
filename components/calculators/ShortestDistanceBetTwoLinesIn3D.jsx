...
const ShortestDistanceBetTwoLinesIn3D = () => {
  const [l, setL] = useLocalStorage('ShortestDistanceBetTwoLinesIn3D_l', '\\sqrt{3}');
  const [m, setM] = useLocalStorage('ShortestDistanceBetTwoLinesIn3D_m', '2');
  const [n, setN] = useLocalStorage('ShortestDistanceBetTwoLinesIn3D_n', '4');
  const [a, setA] = useLocalStorage('ShortestDistanceBetTwoLinesIn3D_a', '1');
  const [b, setB] = useLocalStorage('ShortestDistanceBetTwoLinesIn3D_b', '\\pi');
  const [c, setC] = useLocalStorage('ShortestDistanceBetTwoLinesIn3D_c', '7');
  const [p, setP] = useLocalStorage('ShortestDistanceBetTwoLinesIn3D_p', '\\sqrt{8}');
  const [q, setQ] = useLocalStorage('ShortestDistanceBetTwoLinesIn3D_q', '12');
  const [r, setR] = useLocalStorage('ShortestDistanceBetTwoLinesIn3D_r', '9');
  const [d, setD] = useLocalStorage('ShortestDistanceBetTwoLinesIn3D_d', '2');
  const [e, setE] = useLocalStorage('ShortestDistanceBetTwoLinesIn3D_e', '1');
  const [f, setF] = useLocalStorage('ShortestDistanceBetTwoLinesIn3D_f', '8');
  const [result, setResult] = useLocalStorage('ShortestDistanceBetTwoLinesIn3D_result', undefined);
  const [equation, setEquation] = useLocalStorage('ShortestDistanceBetTwoLinesIn3D_equation', '');
  const [solution, setSolution] = useLocalStorage('ShortestDistanceBetTwoLinesIn3D_solution', '');
  const [showResult, setShowResult] = useLocalStorage('ShortestDistanceBetTwoLinesIn3D_showResult', true);
  const [showSteps, setShowSteps] = useLocalStorage('ShortestDistanceBetTwoLinesIn3D_showSteps', true);
  const [isPointSame, setIsPointSame] = useLocalStorage('ShortestDistanceBetTwoLinesIn3D_isPointSame', false);
  const [note, setNote] = useLocalStorage('ShortestDistanceBetTwoLinesIn3D_note', undefined);
  const mf1 = useRef();
  const mf2 = useRef();
  const mf3 = useRef();
  const mf4 = useRef();
