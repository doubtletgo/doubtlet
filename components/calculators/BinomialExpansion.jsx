...
const BinomialExpansion = () => {
  const [power, setPower] = useLocalStorage('BinomialExpansion_power', '3');
  const [expression, setExpression] = useLocalStorage('BinomialExpansion_expression', '0.5x -2y^2');
  const [equation, setEquation] = useLocalStorage('BinomialExpansion_equation', '');
  const [solution, setSolution] = useLocalStorage('BinomialExpansion_solution', '');
  const [result, setResult] = useLocalStorage('BinomialExpansion_result', undefined);
  const [showResult, setShowResult] = useLocalStorage('BinomialExpansion_showResult', false);
  const [showSteps, setShowSteps] = useLocalStorage('BinomialExpansion_showSteps', true);
  const [note, setNote] = useLocalStorage('BinomialExpansion_note', undefined);
  const [notValid, setNotValid] = useLocalStorage('BinomialExpansion_notValid', false);
