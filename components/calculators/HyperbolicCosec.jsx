...
const HyperbolicCosec = () => {
  ...
  useEffect(() => {
    ...
    setNote(
      renderSteps([
        ...
        {
          value: putSpace(
            `Calculate the value of Cosech( {${latex
              .replace('\\frac', '')
              .split('}{')
              .join('\\above{1pt}')}})`
          ),
  ...
  useEffect(() => {
    ...
    const finalAnswer = [
      {
        value: `The \\space value \\space of \\space Cosech({${parseNumber(
          p || '(X)'
        )} ${
    ...
    const steps = [
      ...
      'br',
      {
        value: `The term <b>Cosech(X)</b> represents the hyperbolic Cosec function.It is a mathematical function <br/> that 
        ...
        The hyperbolic Cosec function Cosech (x), can be defined using exponential functions as follows:
        `,
        type: 'span',
      },
      'br',
      {
        value: `Cosech(X) = \\bold{\\frac{2}{(e^X-e^{-X})}}`,
        type: 'equation',
      },
      {
      ...
      <div className="row image-input-container">
        ...
        <div className="col-sm-12 col-md-6 order-md-1 user-inputs">
          ...
          <div className="row mb-2 align-items-center">
            <div className="col-4 text-right">Cosech(X):-</div>
            <div className="col-8">
...
export default HyperbolicCosec;
