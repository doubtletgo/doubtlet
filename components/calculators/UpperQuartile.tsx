...
const UpperQuartile = () => {
  ...
  useEffect(() => {
    setNote(
      renderSteps([
        ...
        {
          value: putSpace(
            `Calculate the Upper Quartile(Q_3) for given set of values: `
          ),
          type: 'equation',
        },
        {
  ...
  useEffect(() => {
    ...
    const pMultipyN = evalExpression(`(3/4)*(${vals.length})`);
    ...
    const finalAnswer = [
      {
        value: putSpace(
          `The Upper (third) Quartile (Q_3) is = ${convertIntoLatex(answer)}`
        ),
        type: 'equation',
      },
    ];
    ...
    const steps = [
      ...
      {
        value: putSpace(
          `The \\bold{Upper Quartile (Q_3)} is the value below which \\bold{75\\%} of the data falls. `
        ),
        type: 'equation',
      },
      {
        value: putSpace(`It is also known as the 3^{rd} quartile`),
        type: 'equation',
      },
      {
        value: 'Step-1',
      ...
      'br',
      {
        value: `We can calculate the Upper (third) Quartile (Q1) at percentile no. 75`,
        type: 'span',
      },
      'br',
      {
        value: putSpace(
          `The percentile number 75 is  = ${convertIntoLatex(answer)}`
        ),
        type: 'equation',
      },
      {
        value: `<a href="/calculator/percentile-calculator/?a=${values}&b=75"  target="_blank">Click here to see steps for percentile calculation</a>`,
        type: 'span',
      },
      ,
      'hr',
