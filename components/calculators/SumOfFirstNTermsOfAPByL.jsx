...
const SumOfFirstNTermsOfAPByL = () => {
  ...
  useEffect(() => {
    ...
    const finalAnswer = [
      ...
      {
        value: putSpace(
          ` is  \\bold{${valueToKatex(valueToKatex(res))}.} ${
            res == res ? '' : `or ${evalInDecimals(res)}`
          }`
        ),
        type: 'equation',
      },
    ...
    const steps = [
      ...
      {
        value: putSpace(
          `We know that \\bold{Sum of first n  terms(S_n)} in \\bold{Arithmetic}`
        ),
        type: 'equation',
      },
      {
        value: putSpace(`\\bold{sequence} is represented`),
        type: 'equation',
      },
      {
        value: putSpace(
          `by the following formula \\bold{S_n = {{n\\above{1pt}2}\\Bigg\\lbrace (2a+(n-1)(d)}\\Bigg\\rbrace}`
        ),
        type: 'equation',
      },
      {
        value: putSpace(`where a is the`),
        type: 'equation',
      },
      {
        value: putSpace(
          `\\bold{First term} and \\bold{d} is the \\bold{Common difference}.`
        ),
        type: 'equation',
      },
      {
      ...
      {
        value: `S_{{${n}}} = {{{${n}}\\above{1pt}2}\\Bigg\\lbrace (2*{${a}})+({${n}}-1)({${d}})}\\Bigg\\rbrace`,
        type: `equation`,
      },
      {
        value: `After Solving`,
      ...
      {
        value: putSpace(`S_{${n}} = \\bold{{${valueToKatex(multipleOut)}}} `),
        type: `equation`,
      },
      'hr',
      {
...
export default SumOfFirstNTermsOfAPByL;
