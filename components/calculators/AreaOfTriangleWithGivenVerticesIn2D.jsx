...
const AreaOfTriangleWithGivenVerticesIn2D = () => {
  const [x1, setX1] = useLocalStorage('AreaOfTriangleWithGivenVerticesIn2D_x1', 'e^2');
  const [x2, setX2] = useLocalStorage('AreaOfTriangleWithGivenVerticesIn2D_x2', '4');
  const [x3, setX3] = useLocalStorage('AreaOfTriangleWithGivenVerticesIn2D_x3', '5');
  const [y1, setY1] = useLocalStorage('AreaOfTriangleWithGivenVerticesIn2D_y1', '\\sqrt{5}');
  const [y2, setY2] = useLocalStorage('AreaOfTriangleWithGivenVerticesIn2D_y2', '\\sqrt{7}');
  const [y3, setY3] = useLocalStorage('AreaOfTriangleWithGivenVerticesIn2D_y3', '5');
  const [equation, setEquation] = useLocalStorage('AreaOfTriangleWithGivenVerticesIn2D_equation', '');
  const [solution, setSolution] = useLocalStorage('AreaOfTriangleWithGivenVerticesIn2D_solution', '');
  const [showResult, setShowResult] = useLocalStorage('AreaOfTriangleWithGivenVerticesIn2D_showResult', true);
  const [showSteps, setShowSteps] = useLocalStorage('AreaOfTriangleWithGivenVerticesIn2D_showSteps', true);
  const [isPointSame, setIsPointSame] = useLocalStorage('AreaOfTriangleWithGivenVerticesIn2D_isPointSame', false);
  const [result, setResult] = useLocalStorage('AreaOfTriangleWithGivenVerticesIn2D_result', '');
  const [note, setNote] = useLocalStorage('AreaOfTriangleWithGivenVerticesIn2D_note', undefined);
  const mf1 = useRef();
  const mf2 = useRef();
  const mf3 = useRef();
  const mf4 = useRef();
